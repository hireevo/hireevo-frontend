...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="grid min-h-dvh grid-cols-1 bg-surface-subtle lg:grid-cols-[minmax(0,674fr)_minmax(0,766fr)]">
      <div className="flex min-w-0 flex-col px-6 py-8 sm:px-10 lg:py-[54px] lg:pr-0 lg:pl-[8.902%] min-[2000px]:pl-0">
        <div className="mx-auto flex w-full max-w-[530px] flex-1 flex-col lg:mx-0 lg:max-w-none min-[2000px]:mx-auto min-[2000px]:max-w-[555px]">
          ...
          <main
            id="main-content"
            className="flex flex-col pt-[46px] pb-10 lg:ml-[4.072%] lg:w-[86.32%] lg:max-w-[530px] min-[2000px]:ml-[25px] min-[2000px]:w-[530px]"
          >
            {children}
          </main>
        </div>
